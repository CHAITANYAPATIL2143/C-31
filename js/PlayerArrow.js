class PlayerArrow {
  constructor(x, y, width, height) {
    ...
    //write a code for defining an array named trajectoryR
   this. trajectoryR = []
  ...
  display() {
      ...
      if (this.body.velocity.x > 0 && this.body.position.x > 400) {
        ...
        this.trajectoryR.push(position)
      ...
      /****write a correct code to add for loop and to display small dots
           ...
           *******/
           for (var i = 0; i < this.trajectoryR.length; i++) {
            image(this.image, this.trajectoryR[i][0], this.trajectoryR[i][1], 5, 5);
          }
